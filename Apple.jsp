...
PreparedStatement ps=conn.prepareStatement("select * from products limit 0,4");
...
session.setAttribute("product3",product[3]);
%>
...
<div>
<input type="checkbox" name="c4" value="<%=product[3].getModel()%>">Select to cart
